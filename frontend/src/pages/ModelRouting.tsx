...
const ModelRouting: React.FC = () => {
  ...
  // 初始化数据
  useEffect(() => {
    const initialUpstreams: UpstreamServer[] = [
      {
        name: 'ds1_5b',
        servers: [{ address: '10.224.104.141', port: 32201 }],
        keepalive: 64,
        health_check: { enabled: true, path: '/health', interval: 30 }
      },
      {
        name: 'ds7b',
        servers: [{ address: '10.224.104.141', port: 32202 }],
        keepalive: 64,
        health_check: { enabled: true, path: '/health', interval: 30 }
      },
      {
        name: 'ds14b',
        servers: [{ address: '10.224.104.143', port: 32223 }],
        keepalive: 64,
        health_check: { enabled: true, path: '/health', interval: 30 }
      },
      {
        name: 'ds32b',
        servers: [{ address: '10.224.104.138', port: 32224 }],
        keepalive: 64,
        health_check: { enabled: true, path: '/health', interval: 30 }
      },
      {
    ...
    const initialLocations: LocationRule[] = [
      {
      ...
      {
        path: '/ds7b/v1/chat/completions',
        upstream: 'ds7b',
        proxy_cache: false,
        proxy_buffering: false,
        proxy_pass: 'http://ds7b/v1/chat/completions'
      },
      {
        path: '/ds14b/v1/chat/completions',
        upstream: 'ds14b',
        proxy_cache: false,
        proxy_buffering: false,
        proxy_pass: 'http://ds14b/v1/chat/completions'
      },
      {
        path: '/ds32b/v1/chat/completions',
        upstream: 'ds32b',
        proxy_cache: false,
        proxy_buffering: false,
        proxy_pass: 'http://ds32b/v1/chat/completions'
      },
      {
        path: '/ds70b/v1/chat/completions',
        upstream: 'ds70b',
        proxy_cache: false,
        proxy_buffering: false,
        proxy_pass: 'http://ds70b/v1/chat/completions'
      },
      {
        path: '/dsr1l/v1/chat/completions',
        upstream: 'dsr1l',
        proxy_cache: false,
        proxy_buffering: false,
        proxy_pass: 'http://dsr1l/v1/chat/completions'
      }
    ];
