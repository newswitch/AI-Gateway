...
async def lifespan(app: FastAPI):
    ...
    # 初始化MySQL数据库
    database_url = os.getenv("DATABASE_URL", "mysql+aiomysql://ai_gateway:ai_gateway_pass@mysql:3306/ai_gateway_config")
    ...
    try:
        ...
        logger.warning(f"MySQL数据库连接失败，将只使用Redis: {str(e)}")
